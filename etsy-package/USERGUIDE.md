...
- **What:** "We Build Remotes Without Code!" poster in 5 big kid-safe steps.
...
- **The seven mockups:**
  ...
  2. **16-cell feature grid** — 2 tabs × features
...
17. Keep old ZIPs tracked in Git (the `.gitignore` exemption keeps
    `etsy-package/MicrobitRemote-v*.zip` in history) so you can always
