 ...
 * After apply-template.mjs substitutes Micro:bit Remote Builder / Build • Pair • Play — no code required, verify
...
const SCENES = [
  { id: 1, dur: 3,  type: 'title',  text: 'Micro:bit Remote Builder',                   subtitle: 'Build • Pair • Play — no code required' },
  { id: 2, dur: 7,  type: 'image',  src: 'screenshot-build.png', effect: 'zoom-in' },
  { id: 3, dur: 10, type: 'image',  src: 'screenshot-play.png',       effect: 'pan-right' },
  { id: 4, dur: 10, type: 'image',  src: 'screenshot-palette.png',   effect: 'zoom-in' },
  { id: 5, dur: 10, type: 'image',  src: 'screenshot-build.png',    effect: 'pan-left' },
  { id: 6, dur: 10, type: 'image',  src: 'screenshot-play.png',  effect: 'zoom-out' },
  { id: 7, dur: 5,  type: 'cta',    text: 'Full kit',                           subtitle: '' },
  { id: 8, dur: 5,  type: 'end',    text: 'Micro:bit Remote Builder',                   subtitle: '' },
];
...
function sceneImage(s, out) {
  ...
  if (!existsSync(src)) {
    // Back-compat fallback to legacy filename (e.g. screenshot-play.png).
