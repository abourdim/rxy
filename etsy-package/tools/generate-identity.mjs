...
const I18N = {
  en: { tagline: 'See the live demo in 30s.', role: 'rxy · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · rxy', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · rxy', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
