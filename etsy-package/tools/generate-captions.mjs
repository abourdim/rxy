...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم drag-and-drop · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique drag-and-drop · modèles Three.js · source makecode.ts inclus`,
...
TEMPLATES_BY_LANG.en = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `drag-and-drop graph · Three.js models · makecode.ts source included`,
