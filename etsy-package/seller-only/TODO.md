...
> 🧪 **Live demo**: <https://abourdim.github.io/rxy/>
...
- [ ] **Record the 60-second listing video** following
      ...
      with videos by ~30%.
- [ ] **Create the RXYLAUNCH Etsy promo code** (Shop Manager → Marketing
      → Sales & coupons → new code `RXYLAUNCH`, $7 discount off $12.99,
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `MicrobitRemote-v1.0.0.zip` actually contains?
...
- [x] ~~Host a live demo on GitHub Pages~~ — done. Live at
      <https://abourdim.github.io/rxy/>. Already in the
      listing description.
...
- [ ] **Create the RXYLAUNCH promo code** (first 10 buyers: $12.99 → $7
