# Micro:bit Remote Builder → Etsy 1-Minute Demo Playbook
...
## Script Template A — "Micro:bit Remote Builder — Drag-Drop Bluetooth Remote · 12 Widgets · 6 Templates · V1 + V2 · Chrome / Edge" (hero demo)
...
|---|---|---|
| 0–3 s | *"Micro:bit Remote Builder — Drag-Drop Bluetooth Remote · 12 Widgets · 6 Templates · V1 + V2 · Chrome / Edge — in the browser, in 60 seconds."* | Close-up of the real board with the X icon on the LEDs. Your hand holds it. |
...
- Use the listing **title** to echo the video's first words. If you say *"Micro:bit Remote Builder — Drag-Drop Bluetooth Remote · 12 Widgets · 6 Templates · V1 + V2 · Chrome / Edge"*, the listing title starts with the same opening words.
...
```
Browser product V1 or V2. Sensors, widget, live graphs, 3D models, and a D-Pad widget — all from Chrome. No install, no account.
```
...
*Made for Micro:bit Remote Builder v1.0.0 — print this on A4, laminate, keep next to the shoot rig.*
